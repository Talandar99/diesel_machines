...
data:extend({

	{
		type = "item",
		name = "diesel-pump",
		icon = "__diesel_machines__/graphics/diesel-pump/diesel-pump.png",
	...
	},
	{
		...
		animations = {
			north = {
				filename = "__diesel_machines__/graphics/diesel-pump/pump-north.png",
				width = 103,
				height = 164,
				scale = 0.5,
				line_length = 8,
			...
			east = {
				...
				filename = "__diesel_machines__/graphics/diesel-pump/pump-east.png",
				width = 130,
				height = 109,
				scale = 0.5,
				line_length = 8,
			...
			south = {
				filename = "__diesel_machines__/graphics/diesel-pump/pump-south.png",
				width = 114,
				height = 160,
				scale = 0.5,
				line_length = 8,
			...
			west = {
				filename = "__diesel_machines__/graphics/diesel-pump/pump-west.png",
				width = 131,
				height = 111,
				scale = 0.5,
				line_length = 8,
