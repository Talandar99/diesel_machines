	...
	parts = {
		{
			rotated_sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-1",
				{
					priority = "very-low",
					dice = 4,
					direction_count = 128,
		...
		{
			rotated_sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-3",
				{
					priority = "very-low",
					direction_count = 128,
					scale = 0.5,
		...
		{
			rotated_sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-4",
				{
					priority = "very-low",
					direction_count = 128,
					scale = 0.5,
		...
		{
			rotated_sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-5",
				{
					priority = "very-low",
					direction_count = 128,
					scale = 0.5,
		...
		{
			rotated_sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-6",
				{
					priority = "very-low",
					direction_count = 128,
					scale = 0.5,
		...
		{
			rotated_sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-7",
				{
					priority = "very-low",
					direction_count = 128,
					scale = 0.5,
		...
		{
			rotated_sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-8",
				{
					priority = "very-low",
					direction_count = 64,
					scale = 0.5,
		...
		},
		{
			sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-9",
				{
					priority = "very-low",
					scale = 0.5,
				}
		...
		{
			sprite = util.sprite_load(
				"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-crane-10",
				{
					priority = "very-low",
					scale = 0.5,
				}
