...
local function cutpipecovers()
	return {
		north = {
			filename = "__diesel_machines__/graphics/pipe_covers/cut/pipe-N.png",
			priority = "extra-high",
			width = 71,
			height = 38,
		...
		south = {
			filename = "__diesel_machines__/graphics/pipe_covers/cut/pipe-S.png",
			priority = "extra-high",
			width = 88,
			height = 61,
...
data:extend({

	{
		...
		icon = "__diesel_machines__/graphics/diesel-crane-bulk-inserter/diesel-crane-bulk-inserter.png",
		subgroup = "inserter",
		color_hint = { text = "S" },
	...
	},
	{
		...
		hand_base_picture = {
			filename = "__diesel_machines__/graphics/diesel-crane-bulk-inserter/diesel-crane-bulk-inserter-hand-base.png",
			priority = "extra-high",
			width = 32,
			height = 136,
			scale = 0.25,
		...
		hand_closed_picture = {
			filename = "__diesel_machines__/graphics/diesel-crane-bulk-inserter/diesel-crane-bulk-inserter-hand-closed.png",
			priority = "extra-high",
			width = 100,
			height = 164,
			scale = 0.25,
		...
		hand_open_picture = {
			filename = "__diesel_machines__/graphics/diesel-crane-bulk-inserter/diesel-crane-bulk-inserter-hand-open.png",
			priority = "extra-high",
			width = 130,
			height = 164,
			scale = 0.25,
		...
		integration_patch = make_4way_animation_from_spritesheet({
			layers = {
				{
					filename = "__diesel_machines__/graphics/diesel-crane-bulk-inserter/platform-overlay.png",
					priority = "extra-high",
					width = 384,
					height = 192,
					scale = 0.5,
		...
		platform_picture = make_4way_animation_from_spritesheet({
			layers = {
				{
					filename = "__diesel_machines__/graphics/diesel-crane-bulk-inserter/platform.png",
					priority = "extra-high",
					width = 384,
					height = 192,
					scale = 0.5,
