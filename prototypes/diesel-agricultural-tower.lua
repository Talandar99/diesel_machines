...
data:extend({
	{
		...
		icon = "__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower.png",
	...
	},
	{
		...
		animation = {
			filename = "__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-remnants.png",
			line_length = 1,
			width = 250,
			height = 250,
			frame_count = 1,
	...
	},
	{
		...
		radius = 4,
		crane = require("__diesel_machines__.prototypes.diesel-agricultural-tower-crane"),
		...
		graphics_set = {
			animation = {
				layers = {
					util.sprite_load(
						"__diesel_machines__/graphics/diesel-agricultural-tower/agricultural-tower-base",
						{
							priority = "high",
