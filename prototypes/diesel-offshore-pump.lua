...
data.extend({
	{
		type = "offshore-pump",
		name = "diesel-offshore-pump",
		icons = {
			{ icon = "__base__/graphics/icons/offshore-pump.png", icon_size = 64 },
			{
		...
		minable = { mining_time = 0.1, result = "diesel-offshore-pump" },
	...
	},
	{
		...
		order = "b[fluids]-a[diesel-offshore-pump]",
		inventory_move_sound = item_sounds.fluid_inventory_move,
		pick_sound = item_sounds.fluid_inventory_pickup,
		drop_sound = item_sounds.fluid_inventory_move,
		place_result = "diesel-offshore-pump",
		stack_size = 20,
	},
	{
		type = "recipe",
		...
		results = { { type = "item", name = "diesel-offshore-pump", amount = 1 } },
	},
})
table.insert(
	data.raw.technology["diesel-automation"].effects,
	{ type = "unlock-recipe", recipe = "diesel-offshore-pump" }
)
